 ...
 */
public abstract class MbrCreateModel extends AbsICmd {
    private BasicModel basicModel = new BasicModel();

    private String json;

    protected MbrCreateModel(String json) {
        this.json = json;
    ...
    protected void invoke() {
        ...
        MyApplication.log("MbrCreateModel", "url " + url);
        MyApplication.log("MbrCreateModel", "session " + session);
        MyApplication.log("MbrCreateModel", "session " + json);
        ...
        basicModel.requestServer.postApi(url, session, json, new ResponseHandle<RESP_Id>(RESP_Id.class) {
            ...
            protected void onSuccess(RESP_Id obj) {
                MbrCreateModel.this.onSuccess(obj);
            }

            @Override
            protected void onError(Error error) {
                MbrCreateModel.this.onError(error.getCode());
            }
        });
    }

 ...
 */
public abstract class UploadUserAvatarModel extends AbsICmd {
    private BasicModel basicModel = new BasicModel();

    private File file;

    protected UploadUserAvatarModel(File file) {
        this.file = file;
    ...
    protected void invoke() {
        String url = basicModel.BASE_API + basicModel.UPLOAD_USER_AVATAR;
        ...
        basicModel.requestServer.uploadImage(url, session, file, new ResponseHandle<RESP_Upload_Image>(RESP_Upload_Image.class) {
            ...
            protected void onSuccess(RESP_Upload_Image obj) {
                UploadUserAvatarModel.this.onSuccess(obj);
            }

            @Override
            protected void onError(Error error) {
                UploadUserAvatarModel.this.onError(error.getCode());
            }
        });
    }

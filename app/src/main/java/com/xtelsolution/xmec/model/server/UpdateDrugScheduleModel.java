 ...
 */
public abstract class UpdateDrugScheduleModel extends AbsICmd {
    private BasicModel basicModel = new BasicModel();

    private String json;

    protected UpdateDrugScheduleModel(String json) {
        this.json = json;
    ...
    protected void invoke() {
        ...
        basicModel.requestServer.putApi(url, session, json, new ResponseHandle<RESP_Basic>(RESP_Basic.class) {
            ...
            protected void onSuccess(RESP_Basic obj) {
                UpdateDrugScheduleModel.this.onSuccess();
            }

            @Override
            protected void onError(Error error) {
                UpdateDrugScheduleModel.this.onError(error.getCode());
            }
        });
    }

 ...
 */
public class SharedItemFragment extends BasicFragment implements MbrItemView {
    ...
    public static SharedItemFragment newInstance(int mbrId) {
    ...
    private void initActionListener() {
        ...
        txtShareTo.setVisibility(View.INVISIBLE);

...
public class BubbleTransformation implements com.squareup.picasso.Transformation {
    ...
    public Bitmap transform(final Bitmap source) {
        ...
        paintBorder.setColor(MyApplication.context.getResources().getColor(R.color.colorPrimaryDark));
        ...
        trianglePaint.setColor(MyApplication.context.getResources().getColor(R.color.colorPrimaryDark));
